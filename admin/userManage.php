        ...
        <div class="col-lg-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered text-center">
                    <thead style="background-color: rgb(172 125 152);">
                        <tr>
                            <th>UserId</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/bitedash/user/img/person-' .$Id. '.jpg" alt="image for this user" onerror="this.src =\'/bitedash/user/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="User Actions">
                                            <button class="btn btn-primary" data-toggle="modal" data-target="#editUser' .$Id. '">Edit</button>';
                                            if($Id == 1) {
                                                echo '<button class="btn btn-danger" disabled>Delete</button>';
                                            } else {
                                                echo '<form action="partials/_userManage.php" method="POST">
                                                        <button name="removeUser" class="btn btn-danger">Delete</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111, 202, 203);">
        <h5 class="modal-title text-center w-100" id="newUserTitle">Create New User</h5>
      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
          ...
          <div class="form-group row my-0">
            <div class="form-group col-md-6 my-0">
              ...
              <div class="input-group mb-3">
                ...
                <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter Phone No" maxlength="10">
              </div>
            </div>
            <div class="form-group col-md-6 my-0">
          ...
          <button type="submit" name="createUser" class="btn btn-success btn-block">Submit</button>
        </form>
      </div>
    </div>
  </div>
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                ...
                <div class="form-group col-md-4">
                    <img src="/bitedash/user/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/bitedash/user/img/profilePic.jpg'">
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                ...
                <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $phone; ?>"  maxlength="10">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
