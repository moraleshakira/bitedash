<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%" id='notempty'>
    <strong>Info!</strong> If the problem is not related to the order, then order id = 0
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="float-right">
                        <button class="btn btn-danger-gradiant text-white border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history">
                        ...
                        <thead style="background-color: rgb(111 202 203);">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if($count==0) {
                                        echo '<tr><td colspan="8">You have not received any messages!</td></tr>';
                                    }
                                ?>
                            </tbody>
