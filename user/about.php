      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>BiteDash</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Parmar Darshan Kiritbhai</h2><p>TEAM</p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>BiteDash</strong></h3>
            <h3><strong>A cross-platform develompent system for POS system</strong></h3>
            <p class="font-italic">
          </div>
        ...
        <div class="row" >
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="" target=""><i class="icofont-twitter"></i></a>
                  <a href="" target=""><i class="fab fa-github"></i></a>
                  <a href="" target=""><i class="icofont-linkedin" target=""></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Shakira Morales</h4>
                </div>
                <div class="social">
                  <a href=""><i class="icofont-twitter" target=""></i></a>
                  <a href="" target=""><i class="fab fa-github"></i></a>
                  <a href=""><i class="icofont-linkedin" target=""></i></a>
                </div>
              </div>
            </div>
          </div>
